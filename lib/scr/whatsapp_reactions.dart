...
class FbReactionState extends State<FbReaction> with TickerProviderStateMixin {
  ...
  Widget renderBtnLike() {
    return Container(
      ...
      margin: widget.margin ?? const EdgeInsets.only(top: 190.0),
    ...
    if (dragUpdateDetail.globalPosition.dy >= 200 &&
      ...
      if (dragUpdateDetail.globalPosition.dx >= 20 &&
        ...
        if (currentIconFocus != 1) {
          ...
          widget.onchange != null ? (getTextBtn(), 1) : null;
        }
        ...
        if (currentIconFocus != 2) {
          ...
          widget.onchange != null ? (getTextBtn(), 2) : null;
        }
        ...
        if (currentIconFocus != 3) {
          ...
          widget.onchange != null ? (getTextBtn(), 3) : null;
        }
        ...
        if (currentIconFocus != 4) {
          ...
          widget.onchange != null ? (getTextBtn(), 4) : null;
        }
        ...
        if (currentIconFocus != 5) {
          ...
          widget.onchange != null ? (getTextBtn(), 5) : null;
        }
        ...
        if (currentIconFocus != 6) {
          ...
          widget.onchange != null ? (getTextBtn(), 6) : null;
        }
      }
    } else {
  ...
  void onTapBtn() {
    if (!isLongPress) {
      if (whichIconUserChoose == 0) {
        ...
        whichIconUserChoose = 0;
        widget.onchange != null ? (getTextBtn(), 0) : null;
      }
      if (isLiked) {
